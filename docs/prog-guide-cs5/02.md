...
本章的第二部分讨论了如何获得 C#编译器以及使用 Visual Studio 开发 C#应用程序的优势。
...
![9781430245933_Fig02-01.jpg](images/9781430245933_Fig02-01.jpg)
...
因此，pre-JIT 的真正好处是减少了客户机应用程序的 JIT 开销(从而减少了启动时间),而且它在其他地方也不是很有用。
