...
让我们看看如何创建一个只能在 iPad 上运行的应用程序。在 **C# ![images](img/.jpg) iPhone 和 iPad** 模板下创建一个新的基于 iPad 窗口类型项目的解决方案，如图[图 4–1](#fig_4_1)所示。
...
要指定在模拟器上运行应用程序时模拟哪个设备，请将**项目** ![images](img/.jpg) ** iPhone 模拟器目标**设置为 **iPhone** 或 **iPad** 。
