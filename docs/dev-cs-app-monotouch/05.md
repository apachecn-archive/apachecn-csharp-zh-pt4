...
然而，我们真的不必太担心这一点，因为默认的 MonoDevelop**View Interface Definition with Controller**模板为我们做了这件事，就像我们在前面的练习中看到的那样。要查看这方面的示例，请查看`Example_ViewAndViewControllerInCode`示例应用程序。
