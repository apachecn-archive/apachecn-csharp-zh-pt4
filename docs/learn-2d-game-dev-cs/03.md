...
1.  创建一个名为 *GameWindowSize* 的新项目，或者按照 Chapter03\SourceCode\1 中的示例项目进行操作。GameWindowSize 文件夹。如果你需要一个关于如何用 Visual Studio 和MonoGame创建一个新项目的提示，请参考[第 2 章](02.html)“了解MonoGame框架”中的例子
