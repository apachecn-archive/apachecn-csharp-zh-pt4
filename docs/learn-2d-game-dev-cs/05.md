...
![9781430266044_Fig05-01.jpg](img/-01.jpg)
...
![9781430266044_Fig05-04.jpg](img/-04.jpg)
...
在继续之前，这里有一个简短的回顾，以便您可以更好地理解向量分量以及如何将给定的向量分解成它的分量。首先，记住两个垂直的方向可以用来表示矢量的分量。例如，[图 5-5](#Fig5) 包含两个归一化矢量，可以用来表示矢量![image](img/-8.jpg)。归一化向量![image](img/-9.jpg)表示向量![image](img/-11.jpg)的 x 轴方向，归一化向量![image](img/-10.jpg)表示向量的 y 轴方向。

![9781430266044_Fig05-05.jpg](img/-05.jpg)

[图 5-5](#_Fig5) 。向量![image](img/-11.jpg)的归一化分量向量

考虑到这一点，给定归一化垂直矢量![image](img/-12.jpg)和![image](img/-13.jpg)以及任何矢量![image](img/-11.jpg)，以下公式将始终成立。你可以在图 5-6 的[中看到这个原理的示意图。](#Fig6)

![image](img/-1.jpg)

![9781430266044_Fig05-06.jpg](img/-06.jpg)

[图 5-6](#_Fig6) 。旋转分量向量

矢量的组成部分与本项目相关，因为围绕其轴旋转图像带来了新的挑战。没有旋转，标准正交集(标准化的垂直集)简单地由沿着默认 x 轴和 y 轴的向量组成。你在之前的项目中处理过这个案子。你可以在图 5-7 中看到这样的例子。

![9781430266044_Fig05-07.jpg](img/-07.jpg)

[图 5-7](#_Fig7) 。轴对齐的纹理

然而，图像旋转后，参考向量集不再位于 x、y 轴上。因此，碰撞计算必须考虑新旋转的轴![image](img/-12.jpg)和![image](img/-13.jpg)，如图[图 5-8](#Fig8) 所示。

![9781430266044_Fig05-08.jpg](img/-08.jpg)
...
![9781430266044_Fig05-09.jpg](img/-09.jpg)
...
![9781430266044_Fig05-12.jpg](img/-12.jpg)
...
2.  在新的 RotateObject 类中覆盖 Update()函数,以便修改对象的行为。记住调用基本更新函数，以便应用速度。事情是这样的:
    ...
    2.  然后，对象根据其在 x 方向上的速度旋转，通过实现之前导出的等式![image](img/-5.jpg)。
    3.  最后，应用顺时针或逆时针旋转方向:
...
| 模拟旋转 | 通过![image](img/-6.jpg)
根据移动速度旋转对象，例如，模拟水平方向的旋转，在每次更新时，通过![image](img/-7.jpg)旋转对象。向右运动增加旋转角度，而向左运动减少旋转角度。 |
