 ...
 *在MonoGame中，Vector2 类实现了二维(2D)向量的功能。方便的是，您还可以使用 Vector2 类来表示 2D 空间中的位置，比如一个点。在前面的例子中， *P* <sub>*a*</sub> ， *P* <sub>*b*</sub> ，*V*<sub>*ab*</sub>都可以实现为 *Vector2* 类的实例；然而，*V*<sub>*ab*</sub>是唯一数学定义的向量。 *P* <sub>*a*</sub> 和 *P* <sub>*b*</sub> 代表位置，或者用来创建矢量的点。
